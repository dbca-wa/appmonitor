...
urlpatterns = [
    ...
    re_path(r'^platform/view/(?P<pk>[0-9]+)/packages/(?P<package_pk>[0-9]+)/versions/(?P<ecosystem>[a-z|-]+)/$', views.PlatformPackageView.as_view(), name='platform_view'), 
    ...
    re_path(r'^package/(?P<pk>[0-9]+)/version/(?P<version_pk>[0-9]+)/advisory/(?P<ecosystem>[a-z|-]+)/$', views.PackageAdvisoryView.as_view(), name='python_package_advisory'),  
