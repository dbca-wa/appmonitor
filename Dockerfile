...
RUN apt-get install --no-install-recommends -y git curl wget libreoffice skopeo gdal-bin iputils-ping
...
RUN echo "ulimit -m 4096000" >> /etc/bash.bashrc
RUN echo "ulimit -v 4096000" >> /etc/bash.bashrc
